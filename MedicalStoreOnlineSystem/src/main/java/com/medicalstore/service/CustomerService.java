...
public class CustomerService {
	...
	public ResponseEntity<ResponseStructure<CustomerDTO>> updateCustomer(Customer customer,long customerId,long addressId) {
	...
	public ResponseEntity<ResponseStructure<CustomerDTO>> findCustomerById(long customerId) {
		   ...
		   return new ResponseEntity<>(new ResponseStructure<>(HttpStatus.FOUND.value(),
															   "Customer found...",
																this.modelMapper.map(customerDao.findCutomerById(customerId),
																CustomerDTO.class)),
																HttpStatus.FOUND);
	...
	public ResponseEntity<ResponseStructure<CustomerDTO>> forgotPassword(String customerEmail,String newPassword,String phoneNumber){
